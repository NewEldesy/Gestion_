<?php
    ...
    if(isset($_POST['designation']) && isset($_POST['vehicule']) && isset($_POST['pu'])) {
        if(!empty($_POST['designation']) && !empty($_POST['vehicule']) && !empty($_POST['pu'])) {
            $data['designation']=$_POST['designation']; $data['vehicule']=$_POST['vehicule']; $data['pu']=$_POST['pu'];
