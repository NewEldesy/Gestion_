      ...
      <div class="container-fluid w-2550">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title fw-semibold mb-4">Gestion Prestations Tractage</h3>
            <a href="#" id="addPT" data-bs-toggle="modal" data-bs-target="#exampleModalAdd" class="btn btn-primary">
              Nouvelle Prestation Tractage
            </a>
          </div>
          <div class="card-body">
            <div id="result_pt"></div>
            <div id="affPT"></div>
          </div>
        </div>
              ...
              <div class="modal-body">
                <form method="POST">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="proprietaire_contact" required>
                  </div>
                  <div class="mb-3">
                    <label for="lieu_kilometrage" class="form-label">Lieu Kilometrage</label>
                    <input type="text" class="form-control" id="lieu_kilometrage" required>
                  </div>
                  <div class="mb-3">
                  ...
                  <button type="submit" id="btn_add_pt" class="btn btn-primary">Ajouter</button>
                </form>
              </div>
            </div>
          </div>
        ...
        <div class="modal fade" id="exampleModalMaj" tabindex="-1" aria-labelledby="UpdateModal" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div id="pt_mod"></div>
                <button type="submit" id="btn_maj_pt" class="btn btn-primary">Modifier</button>
              </div>
            </div>
          </div>
        </div>
